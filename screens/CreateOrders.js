...
export default class CreateOrders extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            item_id: this.props.route.params.embroidered.id_bordado,
            item_valor: this.props.route.params.embroidered.valor,
            item_qtd: 0,
            valor_total: 0
    ...
    calculaTotal = () => {
        ...
        item_valor = parseFloat(item_valor)
        item_qtd = parseInt(item_qtd)
        valor_total = item_valor * item_qtd
        // console.log(valor_total + "VT")
        // console.log(item_qtd + "Q")
        console.log(this.props.route.params.embroidered)
        this.setState({
    ...
    componentDidMount() {
        setInterval(this.calculaTotal, 1000)
                    ...
                    <View style={styles.inputs}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(the_amount) => {
                                ...
                                this.setState({ item_qtd: parseInt(the_amount) })
                            }}
                        ...
                        <View style={styles.style2}>
                            <Text style={[styles.routeText, { marginLeft: 20 }]}>
                                Valor total: R${this.state.valor_total},00
                            </Text>
                        </View>
                    </View>
